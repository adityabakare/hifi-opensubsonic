...
import { Music, CheckCircle2, AlertCircle, Copy, LogOut, ArrowLeft, Disc3 } from 'lucide-react';
...
function Dashboard() {
  ...
  const navigate = useNavigate();
  const [lastfmLinked, setLastfmLinked] = useState<boolean>(false);
  ...
  const handleLastfmConnect = async () => {
    try {
      ...
      callbackObj.search = ''; // clear existing query params
    ...
    <div className="min-h-screen bg-neutral-950 flex flex-col items-center justify-center p-4">
      <Card className="w-full max-w-md bg-neutral-900 border-neutral-800 text-neutral-100 shadow-2xl relative overflow-hidden">
        ...
        <CardContent className="space-y-4 pt-4">
          ...
          <div className="space-y-2 p-3 bg-black/40 rounded-lg border border-neutral-800 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-neutral-400">
                    {lastfmLinked 
                      ...
                      : "Connect your account to scrobble tracks."}
                  </p>
                </div>
              </div>
              
              {lastfmLinked ? (
                <Button variant="outline" size="sm" onClick={handleLastfmDisconnect} className="border-neutral-700 bg-neutral-900 hover:bg-red-950 hover:text-red-400 hover:border-red-900">
                  Disconnect
                </Button>
              ) : (
                <Button size="sm" onClick={handleLastfmConnect} disabled={isLinking} className="bg-red-600 hover:bg-red-700 text-white">
